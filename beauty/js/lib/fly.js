/*! flyui-core v1.1.5 | by huanzhang & ueteam | Licensed under ISC | 2016-06-28 17:06:45 CST */
(function e(t, n, r) {
    function s(o, u) {
        if (!n[o]) {
            if (!t[o]) {
            ...
            binders.source = Binder.extend({
                ...
                render: function() {
                    ...
                    if (this.bindings.template) {
                        ...
                        element.innerHTML = this.bindings.template.render(source);
        ...
        function(require, module, exports) {
            ...
            var Component = Observable.extend({
                ...
                _tabindex: function(target) {
                    ...
                    var element = this.element,
                        tabindex = target.getAttribute(TABINDEX) || element.getAttribute(
                            TABINDEX);

                    element.removeAttribute(TABINDEX);
                    target.setAttribute(TABINDEX, !isNaN(tabindex) ? tabindex : 0);
                },
                ...
                render: function() {
                    ...
                    if (this.template) {
                        ...
                        _id && newElement.setAttribute('id', _id);
                        _class && newElement.setAttribute('class', (newElement.getAttribute(
                            'class') || '') + ' ' + _class);
                        _title && newElement.setAttribute('title', _title);
        ...
        this._skipRequestsInProgress = false;
            ...
            var NodeDataSource = DataSource.extend({
                ...
                _find: function(method, value, key) {
                    ...
                    node = this._super[method].call(this, value);
            ...
            var Node = Model.define({
                ...
                ctor: function(value) {
                    ...
                    if (typeof hasChildren === STRING) {
                        hasChildren = getter(hasChildren);
                    }
            ...
            data.errors = EMPTY;
                ...
                data: function(data) {
                    if (isPlainObject(data)) {
                        data = getter(this.read.rowsField)(data);
                    } else if (!data) {
                        data = [];
                    }
                    return data;
                ...
                total: function(data) {
                    var length = 0;
                    if (isPlainObject(data)) {
                        length = getter(this.read.totalField)(data);
